...
public:
	...
	[[eosio::on_notify("evolutiondex::addliquidity")]] void onaddliquidity(name user, asset to_buy, asset max_asset1, asset max_asset2);
	[[eosio::on_notify("evolutiondex::remliquidity")]] void onremliquidity(name user, asset to_sell, asset min_asset1, asset min_asset2);
	[[eosio::on_notify("evolutiondex::transfer")]] void ontransfer(
